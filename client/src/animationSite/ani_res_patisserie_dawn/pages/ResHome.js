...
import { FadeOut, FadeIn } from "../../../shared/components";
  ...
  return (
    <div>
      <div className=" relative h-[400vh] bg-black text-white KinutaShinStdN6K">
        <div
          className="overflow-hidden w-[100vw] h-[100vh] sticky top-0 z-1 transition-all duration-300 ease-in-out"
        ...
        <div className="absolute w-[100vw] top-0 z-5">
          <section className="relative w-full h-[100vh] flex items-center justify-around block">
            ...
            <motion.div
              {...resFirstMotion}
              className="flex flex-col items-center KinutaShinStdN6K"
            >
              <p>Patisserie</p>
            ...
            <motion.div
              {...resFirstMotion}
              className="kinuta-maruminfuji-stdn text-[25px]"
            >
              <p>
                世界が静かに切り替わる
                <br />
        ...
        <section className="w-[100vw] sticky top-0 z-5">
          <div className="w-full h-[100vh] flex items-center justify-evenly">
            ...
            <FadeIn className="kinuta-maruminfuji-stdn string-ss leading-[40px]">
              <p>
                心がふっと軽くなる瞬間って、 <br />
                案外、甘いものの中にある気がする。
                <br />
      ...
      <section className="relative w-full h-[500lvh]">
        ...
        <FadeOut key="ani2">
          <img
            ...
            onMouseEnter={() => handleMouseEnter(2)}
            onMouseLeave={handleMouseLeave}
            className="tracked-element2 absolute w-[600px] h-[750px] top-[18%] left-[55%]"
        ...
        <img
          onMouseEnter={() => handleMouseEnter(2)}
          onMouseLeave={handleMouseLeave}
          className="tracked-element absolute  w-[600px] h-[900px] top-[42%] left-0"
        ...
        <FadeOut key="ani3">
          <img
            onMouseEnter={() => handleMouseEnter(2)}
            onMouseLeave={handleMouseLeave}
            className="tracked-element2 absolute  w-[450px] h-[300px] top-[44%] right-0"
        ...
        <img
          onMouseEnter={() => handleMouseEnter(2)}
          onMouseLeave={handleMouseLeave}
          className="tracked-element absolute  w-[600px] h-[900px] top-[55%] right-0"
      ...
      <section className="section-frame flex flex-col justify-center">
        ...
        <FadeIn className="flex items-center justify-evenly overflow-x-scroll px-[100px] space-x-[100px]">
